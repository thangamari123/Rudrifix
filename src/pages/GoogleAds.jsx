...
const faqs = [
  {
    ...
    a: "Budget recommendations depend heavily on your industry's Cost-Per-Click (CPC) and your goals. We usually recommend a starting budget that is sufficient to generate enough daily clicks to gather statistically significant data within the first month."
  },
  {
    q: "Do you charge a flat fee or percentage of ad spend?",
    a: "We offer flexible pricing models depending on the size and complexity of your campaigns, ensuring our goals are perfectly aligned with your business growth."
  },
  {
    q: "How quickly will I see results?",
    a: "Unlike SEO, Google Ads can generate traffic and leads the very same day the campaigns go live. However, the campaigns will continue to optimize and perform better over the first few weeks as we gather data and refine our bidding strategies."
  }
];

const processes = [
  { step: '01', title: 'Deep Keyword Research', desc: "We discover the high-intent keywords your ideal customers use and identify negative keywords to ensure your ads don't trigger for irrelevant searches." },
  { step: '02', title: 'Ad Copy & Landing Pages', desc: "We write persuasive ad copy and consult on highly optimized landing pages that align perfectly with the ad's promise to maximize conversions." },
  { step: '03', title: 'Execution & Launch', desc: 'We launch targeted Search, Display, Shopping, and Performance Max campaigns customized to your audience.' },
  { step: '04', title: 'Continuous Bid Management', desc: 'We actively monitor your campaigns, adjusting bids based on device, location, time of day, and performance data to maximize ROI.' }
];
    ...
    <div className="min-h-screen bg-[#E0F1FB] text-gray-900 selection:bg-blue-500/30">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <span className="text-sm font-bold text-blue-800 tracking-wide uppercase">Premium PPC Services</span>
          </motion.div>
          ...
          >
            Stop wasting money on clicks that don't convert. We build high-performing Pay-Per-Click campaigns that target users exactly when they are searching for what you offer.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-4 relative z-10">Instant Visibility, Measurable Results</h3>
              <p className="text-gray-600 text-lg leading-relaxed max-w-xl relative z-10">
                While SEO is a fantastic long-term strategy, sometimes you need leads right now. Google Ads puts your business at the very top of the search results the moment your campaign goes live. But navigating the complex Google Ads platform without expertise can drain your budget quickly.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 relative z-10">Focus on Conversions</h3>
              <p className="text-gray-600 relative z-10">We don't measure success by clicks. We measure success by how many form fills, calls, or purchases those clicks generated.</p>
            </motion.div>
      ...
      <section id="process" className="py-24 bg-white/50 border-y border-blue-100 relative z-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6">Our Ads Strategy</h2>
      ...
      <section className="hidden py-24 relative z-10 bg-white/50 border-t border-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-8">Dominating Tamil Nadu with Expert Google Ads Management Agency</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-12">
            We provide top-tier google ads management agency across all major cities in Tamil Nadu. Connect with our local experts today.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            {["Chennai", "Coimbatore", "Madurai", "Tiruchirappalli", "Salem", "Tiruppur", "Erode", "Tirunelveli", "Thoothukudi", "Tuticorin"].map((city) => (
              <div key={city} className="px-6 py-3 bg-white border border-blue-100 rounded-2xl shadow-sm text-gray-700 font-medium hover:bg-blue-50 hover:text-blue-700 hover:border-blue-300 transition-all hover:-translate-y-1 cursor-default flex items-center gap-2">
                <span className="text-blue-500">📍</span> Google Ads Management Agency {city}
              </div>
            ))}
          </div>
        </div>
