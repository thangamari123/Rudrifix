    ...
    <div className="min-h-screen bg-[#E0F1FB] text-gray-900 selection:bg-blue-500/30">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            Elevate your brand and drive measurable results with our specialized performance analytics solutions, tailored exactly to your business needs.
          </motion.p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-gray-600 text-lg leading-relaxed max-w-xl relative z-10">
                We don't just execute; we strategize for maximum ROI. Our performance analytics strategies are built on data, creativity, and a relentless focus on growing your bottom line.
              </p>
            </motion.div>
      ...
      <section className="hidden py-24 relative z-10 bg-white/50 border-t border-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-8">Dominating Tamil Nadu with Expert Performance Analytics</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-12">
            We provide top-tier performance analytics across all major cities in Tamil Nadu. Connect with our local experts today.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            {["Chennai", "Coimbatore", "Madurai", "Tiruchirappalli", "Salem", "Tiruppur", "Erode", "Tirunelveli", "Thoothukudi", "Tuticorin"].map((city) => (
              <div key={city} className="px-6 py-3 bg-white border border-blue-100 rounded-2xl shadow-sm text-gray-700 font-medium hover:bg-blue-50 hover:text-blue-700 hover:border-blue-300 transition-all hover:-translate-y-1 cursor-default flex items-center gap-2">
                <span className="text-blue-500">📍</span> Performance Analytics {city}
              </div>
            ))}
          </div>
        </div>
