...
export default function Branding() {
  ...
  return (
    <div className="min-h-screen bg-[#E0F1FB] text-gray-900 selection:bg-blue-500/30">
      <SEO 
        canonicalUrl="/branding"
        title="Branding & Visual Identity | Expert Agency Services | Rudrifix"
        description="Professional Branding & Visual Identity services by Rudrifix. We help businesses scale with data-driven strategies and premium execution."
        keywords="Branding & Visual Identity Chennai, Branding & Visual Identity Coimbatore, Branding & Visual Identity Madurai, Branding & Visual Identity Tiruchirappalli, Branding & Visual Identity Salem, Branding & Visual Identity Tiruppur, Branding & Visual Identity Erode, Branding & Visual Identity Tirunelveli, Branding & Visual Identity Thoothukudi, Branding & Visual Identity Tuticorin"
      />
