...
export default function LinkedInAds() {
  ...
  return (
    <div className="min-h-screen bg-[#E0F1FB] text-gray-900 selection:bg-blue-500/30">
      <Helmet>
        <title>LinkedIn Advertising | Expert Agency Services | Rudrifix</title>
        <meta name="description" content="Professional LinkedIn Advertising services by Rudrifix. We help businesses scale with data-driven strategies and premium execution." />
        <meta name="keywords" content="LinkedIn Advertising Chennai, LinkedIn Advertising Coimbatore, LinkedIn Advertising Madurai, LinkedIn Advertising Tiruchirappalli, LinkedIn Advertising Salem, LinkedIn Advertising Tiruppur, LinkedIn Advertising Erode, LinkedIn Advertising Tirunelveli, LinkedIn Advertising Thoothukudi, LinkedIn Advertising Tuticorin" />
      </Helmet>
