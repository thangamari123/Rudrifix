...
export default function YouTubeAds() {
  ...
  return (
    <div className="min-h-screen bg-[#E0F1FB] text-gray-900 selection:bg-blue-500/30">
      <SEO 
        canonicalUrl="/youtube-ads"
        title="YouTube Advertising | Expert Agency Services | Rudrifix"
        description="Professional YouTube Advertising services by Rudrifix. We help businesses scale with data-driven strategies and premium execution."
        keywords="YouTube Advertising Chennai, YouTube Advertising Coimbatore, YouTube Advertising Madurai, YouTube Advertising Tiruchirappalli, YouTube Advertising Salem, YouTube Advertising Tiruppur, YouTube Advertising Erode, YouTube Advertising Tirunelveli, YouTube Advertising Thoothukudi, YouTube Advertising Tuticorin"
      />
