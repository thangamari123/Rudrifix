...
const faqs = [
  {
    q: "What makes a custom CRM better than off-the-shelf solutions?",
    a: "A custom CRM is tailored exactly to your unique business processes, eliminating bloatware and integrating seamlessly with your existing tools, leading to higher adoption and efficiency."
  },
  {
    q: "How long does it take to develop a custom SaaS CRM?",
    a: "Development timelines vary based on the complexity of features. Typically, a robust MVP can be launched in 2-3 months, with iterative updates thereafter."
  },
  {
    q: "Do you provide ongoing support and maintenance?",
    a: "Yes, we offer comprehensive post-launch support, including server maintenance, feature enhancements, and scaling optimizations."
  }
];

const processes = [
  { step: '01', title: 'Workflow Analysis', desc: 'We analyze your current sales and operational workflows to identify bottlenecks and requirements.' },
  { step: '02', title: 'Architecture & Design', desc: 'We design a scalable database and intuitive user interface optimized for your team.' },
  { step: '03', title: 'Development & Integration', desc: 'Our engineers build the CRM and integrate it with your existing third-party APIs and tools.' },
  { step: '04', title: 'Testing & Deployment', desc: 'Rigorous security and performance testing before deploying to a secure cloud environment.' }
];

export default function CustomSaaSCrm() {
    ...
    <div className="min-h-screen bg-[#E0F1FB] text-gray-900 selection:bg-blue-500/30">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <span className="text-sm font-bold text-blue-800 tracking-wide uppercase">Software Engineering</span>
          </motion.div>
          ...
          >
            Custom <br className="hidden md:block" />
          ...
          >
            Stop forcing your business to fit off-the-shelf software. We build powerful, bespoke SaaS CRM platforms that perfectly match your workflows and scale with your growth.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <Database className="text-blue-600 mb-6 relative z-10" size={40} />
              <h3 className="text-3xl font-bold text-gray-900 mb-4 relative z-10">Tailored Data Architecture</h3>
              <p className="text-gray-600 text-lg leading-relaxed max-w-xl relative z-10">
                We engineer scalable, secure databases that map exactly to your unique customer journey, providing a single source of truth for your sales, support, and marketing teams.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 relative z-10">Enterprise Security</h3>
              <p className="text-gray-600 relative z-10">Bank-grade encryption, role-based access control, and compliance-ready architecture to protect your most valuable asset: your data.</p>
            </motion.div>
      ...
      <section id="process" className="py-24 bg-white/50 border-y border-blue-100 relative z-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6">Our Development Process</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">From initial workflow analysis to final deployment, we build software the right way.</p>
          </div>
      ...
      <section className="hidden py-24 relative z-10 bg-white/50 border-t border-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-8">Dominating Tamil Nadu with Expert Custom SaaS CRM Development</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-12">
            We provide top-tier custom saas crm development across all major cities in Tamil Nadu. Connect with our local experts today.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            {["Chennai", "Coimbatore", "Madurai", "Tiruchirappalli", "Salem", "Tiruppur", "Erode", "Tirunelveli", "Thoothukudi", "Tuticorin"].map((city) => (
              <div key={city} className="px-6 py-3 bg-white border border-blue-100 rounded-2xl shadow-sm text-gray-700 font-medium hover:bg-blue-50 hover:text-blue-700 hover:border-blue-300 transition-all hover:-translate-y-1 cursor-default flex items-center gap-2">
                <span className="text-blue-500">📍</span> Custom SaaS CRM Development {city}
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-2 sm:py-6 md:py-24 relative overflow-hidden z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center bg-blue-600 border border-blue-500 rounded-[2rem] md:rounded-[3rem] p-8 sm:p-10 md:p-20 relative overflow-hidden shadow-2xl shadow-blue-600/30">
          ...
          <h2 className="text-[28px] leading-tight sm:text-4xl md:text-5xl font-black text-white mb-4 md:mb-6 relative z-10">Ready for a custom CRM?</h2>
          <p className="text-[15px] sm:text-base md:text-xl text-blue-100 mb-8 md:mb-10 leading-snug md:leading-relaxed max-w-2xl mx-auto relative z-10">Stop adapting to software. Let us build software that adapts to you.</p>
