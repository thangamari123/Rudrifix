...
function ProjectCard({ project }) {
  return (
    <div className="bg-white rounded-[24px] border border-slate-200 shadow-xl shadow-slate-200/30 flex flex-col h-full transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-indigo-500/15 group overflow-hidden">
      
      {/* ── Image Area: Browser Mockup ── */}
      <div className="bg-slate-50/80 border-b border-slate-100 p-4 sm:p-6 flex flex-col items-center justify-center relative overflow-hidden">
         ...
         {/* Browser Frame */}
         <div className="w-full bg-white rounded-t-xl rounded-b-lg shadow-lg border border-slate-200/80 overflow-hidden flex flex-col relative z-10 transition-transform duration-500 group-hover:scale-[1.03]">
           {/* Browser dots */}
           <div className="h-6 bg-slate-100/80 border-b border-slate-200/80 flex items-center px-3 gap-1.5 shrink-0 backdrop-blur-sm">
      ...
      <div className="flex flex-col flex-1 p-5 sm:p-6 bg-white">
        <h3 className="text-xl font-black text-[#0F172A] mb-2 leading-tight group-hover:text-indigo-600 transition-colors">
          {project.title}
        </h3>
        
        <p className="text-slate-500 text-xs sm:text-sm leading-relaxed mb-6 flex-1 line-clamp-3">
          {project.desc}
        </p>
        ...
        <a 
          ...
          className="w-full flex items-center justify-center gap-2 py-3.5 bg-slate-900 text-white font-bold rounded-xl text-sm transition-all hover:bg-indigo-600 hover:shadow-lg hover:shadow-indigo-500/20 active:scale-95 mt-auto"
        >
          View Live Website
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" ref={ref}>
        ...
        <div className="text-center mb-10 sm:mb-14">
          ...
          >
            <span className="text-indigo-600 text-xs font-black uppercase tracking-widest">Our Work</span>
          </motion.div>
